...
%  └────────────────────────┘
    ...
    \newfloatcommand{capbtabbox}{table}[][\FBwidth] % puts table in a box
...
%  └────────────────────────┘
    ...
    \DeclareDocumentCommand{\linear}{} {
        ...
        \begin{tabulary}{\linewidth}{rcc}	
            & \multicolumn{2}{c}{Errors in \%}                        \\
            \toprule % ---------------------------------------
            Method				        &   Training   &  Test      \\ 
            \toprule % ---------------------------------------
            Linear Regression 		    &      14.0    &  20    \\
            Quadratic Regression	    &      14.5    &  20    \\
            Linear Discriminant Analysis&      15.0    &  20    \\
            Quadratic Discriminant Analysis	&  14.5    &  20    \\
            Logistic Regression     	&      14.0    &  20    \\
            1-Nearest Neighbor	    	&      00.0    &  22    \\
            5-Nearest Neighbor	    	&      12.0    &  20    \\
            15-Nearest Neighbor         &      16.0    &  19    \\
            Bayes Naive 	            &              &        \\
            \bottomrule % ---------------------------------------
        \end{tabulary}\label{} 
